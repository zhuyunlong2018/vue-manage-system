    ...
    <div class="sidebar">
        <el-menu class="sidebar-el-menu" :default-active="onRoutes" :collapse="collapse" background-color="#324157"
            ...
            <template v-for="(menu,index) in menus">
                <template v-if="menu.children.length && menuIds.indexOf(menu.id)>-1">
                    <el-submenu :index="menu.path?menu.path:index.toString()" :key="menu.id">
                        ...
                        <template v-for="(subMenu,_index) in menu.children">
                            <el-submenu v-if="subMenu.children.length && menuIds.indexOf(subMenu.id)>-1" :index="subMenu.path?subMenu.path:index.toString()+_index.toString()" :key="subMenu.id">
